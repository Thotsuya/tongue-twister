export default function AudiovisualProcess({ stepNumber, title, description, description2, isHovered, setIsHovered, svgIcon }) {
    return (
        <div className=" group cursor-pointer flex mt-2 md:mt-0 w-[40%] sm:w-[20%] h-[300px] overflow-hidden transition-all duration-700 ease-in-out hover:w-[60%] hover:md:w-[40%]"
            ...
            <div className="rounded-2xl flex flex-col justify-around items-center bg-primary text-white transition transform ease-linear duration-300 px-3 group-hover:bg-[#FFF] group-hover:text-[#262626] group-hover:shadow-none group-hover:border-2">
                ...
                <div className="w-fit flex flex-col items-center gap-2 "> 
                    <h1 className="text-xs w-[62px] font-semibold text-center">{title}</h1>
                    <span>{isHovered ?
            ...
            <div className="transition-all duration-500 opacity-0 overflow-hidden group-hover:opacity-100 flex flex-col justify-around ">
                ...
                <div className="text-sm text-start font-semibold">
                    <h1 className="text-[#262626]">{description} <br /> {description2} </h1>
                </div>
            </div> 
        </div>
    );
